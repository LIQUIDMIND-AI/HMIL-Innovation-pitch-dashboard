    ...
    <aside className="flex h-full w-72 shrink-0 flex-col border-r border-border bg-surface sm:w-64">
      ...
      <nav className="flex-1 px-2 py-3" aria-label="Primary">
        <Link
          href={`/${persona.role}`}
          onClick={onNavigate}
          className="flex min-h-11 items-center gap-2 rounded-md bg-navy-light px-3 py-2 text-sm font-medium text-navy focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-navy"
        >
